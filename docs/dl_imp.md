...
|**Presto/Trino**|Presto was created at Facebook as a project and was later divided into PrestoDB and PrestoSQL. The latter one was rebranded as Trino in 2021. Presto (PrestSQL) is a distributed SQL query engine optimized for ad-hoc analysis. It can query data from various data sources, including Hadoop, making it a good choice for querying data in a data lake. <br/> https://prestodb.io/ <br/> https://trino.io/ |

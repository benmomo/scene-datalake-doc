...
|**Apache ORC (Optimized Row Columnar)** |BORC is a self-describing type-aware columnar file format designed for Hadoop workload (commonly used in Hive). RC is significantly faster than RC File or Parquet, and is being used by Facebook and Yahoo. <br/>[https://orc.apache.org/](https://orc.apache.org/) |
